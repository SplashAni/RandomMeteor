...
public class Feetrap extends Mod {
    ...
    public Feetrap() {
        ...
        centerSettingGroup = register(CenterSettingGroup.class);
        ...
        if (placeSettingGroup.instant.get()) {
            for (BlockPos pose : poses) {
                ticks = TimerUtil.applyDelay(
                    BlockUtil.place(pose, placeSettingGroup, rangeSettingGroup, swapSettingGroup, swingSettingGroup, centerSettingGroup,this),
                    delaySettingGroup
                );
            }
        } else {
            ticks = TimerUtil.applyDelay(
                BlockUtil.place(poses.getFirst(), placeSettingGroup, rangeSettingGroup, swapSettingGroup, swingSettingGroup, centerSettingGroup,this),
                delaySettingGroup
            );
        }
